import subprocess
import os
from test_functions import preprocessing_bottom_power, model_testing, replace_strategy_in_file, modify_proximal_mu, modify_k_fold, prepare_test_database
import pickle
import numpy as np
import pandas as pd
...
model_type = "Bottom-power"
model = preprocessing_bottom_power()

# Variables for running flwr command
cwd = os.getcwd()
working_directory = cwd + "/Federated_Learning_Bottom_Power"
command = ["flwr", "run"]

# Variables to modify strategy for flwr
strategy_file = "/Federated_Learning_Bottom_Power/Program/server_app.py"
strategy_target_line = 48
FedProx_target_line = 54
k_fold_file = "/Federated_Learning_Bottom_Power/Program/task.py"
